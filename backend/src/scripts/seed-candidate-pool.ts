...
const CANDIDATES_DATA = [
  // --- 1. IT & SOFTWARE (6 Ứng viên) ---
  {
    ...
    careerObjective:
      'Kỹ sư Frontend với 4 năm kinh nghiệm chuyên sâu về React/Next.js và tối ưu hóa trải nghiệm người dùng trên các hệ thống SaaS quy mô lớn.',
    education: [
      {
    ...
    workExperience: [
      {
        ...
        endDate: 'Hiện tại',
        description:
          'Chịu trách nhiệm kiến trúc Frontend cổng thanh toán ZaloPay, tối ưu FCP < 0.8s.',
      },
      {
        companyName: 'Sapo Technology',
        position: 'Frontend Developer',
        startDate: '06/2020',
        endDate: '06/2022',
        description:
          'Phát triển giao diện quản lý bán hàng đa kênh POS bằng React và TypeScript.',
      },
    ],
  },
  {
    ...
    careerObjective:
      'Lập trình viên Backend định hướng phát triển kiến trúc Microservices phân tán chịu tải cao và hệ thống Event-driven với Kafka.',
    education: [
      {
    ...
    workExperience: [
      {
        ...
        endDate: 'Hiện tại',
        description:
          'Thiết kế API thanh toán và xử lý đơn hàng chịu tải 50,000 req/s dịp Mega Sale.',
      },
      {
        ...
        endDate: '06/2023',
        description:
          'Xây dựng RESTful API và tối ưu câu truy vấn TypeORM PostgreSQL.',
      },
    ],
  },
  {
    ...
    careerObjective:
      'Chuyên gia DevOps 5+ năm kinh nghiệm quản trị hạ tầng Cloud AWS và triển khai tự động hóa CI/CD cho các doanh nghiệp Fintech.',
    education: [
      {
    ...
    workExperience: [
      {
        ...
        endDate: 'Hiện tại',
        description:
          'Quản lý cụm Kubernetes EKS 50+ nodes, giảm chi phí Cloud hạ tầng xuống 35%.',
      },
      {
        ...
        endDate: '07/2022',
        description:
          'Triển khai hạ tầng AWS bằng Terraform và viết pipeline CI/CD Gitlab.',
      },
    ],
  },
  {
    ...
    careerObjective:
      'Lập trình viên ứng dụng di động đa nền tảng với hơn 2.5 năm kinh nghiệm đưa 5+ ứng dụng lên Google Play & Apple App Store.',
    education: [
      {
    ...
    workExperience: [
      {
        companyName: 'Amanotes Vietnam',
        position: 'Flutter Developer',
        startDate: '07/2023',
        endDate: 'Hiện tại',
        description:
          'Phát triển game âm nhạc tương tác với hơn 5 triệu lượt tải.',
      },
    ],
  },
  {
    ...
    careerObjective:
      'Kỹ sư AI ứng dụng mô hình ngôn ngữ lớn (LLMs) và RAG vào giải pháp tìm kiếm thông minh và phân tích văn bản.',
    education: [
      {
    ...
    workExperience: [
      {
        ...
        endDate: 'Hiện tại',
        description:
          'Phát triển hệ thống RAG cho trợ lý ảo doanh nghiệp, đạt độ chính xác trích xuất 94%.',
      },
    ],
  },
  {
    ...
    careerObjective:
      'Chuyên viên kiểm thử tự động hóa 3 năm kinh nghiệm xây dựng Automation Framework từ đầu cho web và mobile.',
    education: [
      {
    ...
    workExperience: [
      {
        ...
        endDate: 'Hiện tại',
        description:
          'Xây dựng bộ test Playwright tự động chạy hàng ngày trong CI pipeline, giảm 60% lỗi hồi quy.',
      },
      {
        companyName: 'Global CyberSoft',
        position: 'Manual & QC Engineer',
        startDate: '06/2021',
        endDate: '07/2022',
        description:
          'Kiểm thử chức năng và tích hợp cho hệ thống quản lý logistics.',
      },
    ],
  },
  ...
  // --- 2. SALES & KINH DOANH (4 Ứng viên) ---
  {
    ...
    careerObjective:
      'Hơn 5 năm kinh nghiệm dẫn dắt đội ngũ môi giới bất động sản cao cấp, đạt danh hiệu Top 1 Best Seller năm 2023 với doanh số trên 150 tỷ VNĐ.',
    education: [
      {
    ...
    workExperience: [
      {
        ...
        endDate: 'Hiện tại',
        description:
          'Quản lý team 15 chuyên viên, trực tiếp phân phối thành công 120 căn hộ cao cấp khu Đông TP.HCM.',
      },
      {
        companyName: 'CenLand',
        ...
        endDate: '05/2021',
        description:
          'Tư vấn phân khúc biệt thự nghỉ dưỡng và shophouse thương mại.',
      },
    ],
  },
  {
    ...
    careerObjective:
      'Chuyên viên kinh doanh giải pháp phần mềm B2B với 3 năm kinh nghiệm ký kết các hợp đồng doanh nghiệp lớn.',
    education: [
      {
        schoolName: 'Đại học Ngoại thương Hà Nội',
    ...
    workExperience: [
      {
        ...
        endDate: 'Hiện tại',
        description:
          'Khai thác và chốt hợp đồng phần mềm hóa đơn điện tử cho 80+ doanh nghiệp vừa và lớn.',
      },
    ],
  },
  {
    ...
    careerObjective:
      '4 năm kinh nghiệm tư vấn giải pháp quản lý gia sản và bảo hiểm, 2 năm liên tiếp đạt danh hiệu MDRT danh giá.',
    education: [
      {
    ...
    workExperience: [
      {
        companyName: 'Manulife Vietnam',
        position: 'Chuyên viên Hoạch định Tài chính Cấp cao',
        startDate: '08/2020',
        endDate: 'Hiện tại',
        description:
          'Quản lý danh mục 300+ khách hàng cá nhân cao cấp, doanh số phí bảo hiểm năm đạt 3.5 tỷ VNĐ.',
      },
    ],
  },
  {
    ...
    careerObjective:
      'Kỹ năng giao tiếp truyền cảm, kiên nhẫn, luôn vượt chỉ tiêu cuộc gọi và tỷ lệ chuyển đổi khách hàng tiềm năng > 25%.',
    education: [
      {
        schoolName: 'Đại học Mở TP.HCM',
    ...
    workExperience: [
      {
        companyName: 'California Fitness & Yoga',
        position: 'Telesales Consultant',
        startDate: '07/2024',
        endDate: 'Hiện tại',
        description:
          'Thực hiện trung bình 100 cuộc gọi/ngày, đạt tỷ lệ hẹn lịch tham quan thành công 30%.',
      },
    ],
  },
  ...
  // --- 3. MARKETING & MEDIA (4 Ứng viên) ---
  {
    ...
    careerObjective:
      '4 năm kinh nghiệm quản lý ngân sách quảng cáo Performance trên 2 tỷ VNĐ/tháng, tối ưu chỉ số ROAS > 4.5.',
    education: [
      {
        schoolName: 'Đại học Thương mại',
        major: 'Marketing & Thương mại Điện tử',
        startDate: '09/2017',
        endDate: '06/2021',
      },
    ],
    workExperience: [
      {
        companyName: 'AdAsia Digital Agency',
        position: 'Performance Marketing Lead',
        startDate: '08/2021',
        endDate: 'Hiện tại',
        description:
          'Lên chiến lược chạy ads đa kênh cho các nhãn hàng FMCG và E-commerce hàng đầu.',
      },
    ],
  },
  {
    ...
    careerObjective:
      'Biên tập viên nội dung sáng tạo với hơn 2.5 năm kinh nghiệm sản xuất video ngắn TikTok đạt hàng triệu lượt xem.',
    education: [
      {
        schoolName: 'Đại học Khoa học Xã hội & Nhân văn TP.HCM',
    ...
    workExperience: [
      {
        companyName: 'Điền Quân Media',
        position: 'Creative Content Executive',
        startDate: '07/2023',
        endDate: 'Hiện tại',
        description:
          'Xây dựng kênh TikTok doanh nghiệp từ 0 lên 250,000 người theo dõi trong 6 tháng.',
      },
    ],
  },
  {
    ...
    careerObjective:
      '5 năm kinh nghiệm SEO tổng thể đưa hàng nghìn từ khóa cạnh tranh cao lọt Top 1 - 3 Google bền vững.',
    education: [
      {
    ...
    workExperience: [
      {
        companyName: 'GTV SEO Agency',
        position: 'SEO Project Manager',
        startDate: '07/2020',
        endDate: 'Hiện tại',
        description:
          'Triển khai dự án SEO cho 40+ đối tác, tăng lưu lượng truy cập tự nhiên (Organic Traffic) trung bình 300%.',
      },
    ],
  },
  {
    ...
    careerObjective:
      'Năng động, tư duy thị giác tốt, đam mê xây dựng câu chuyện thương hiệu truyền cảm hứng và gia tăng nhận diện nhãn hàng.',
    education: [
      {
        schoolName: 'Học viện Báo chí & Tuyên truyền',
    ...
    workExperience: [
      {
        companyName: 'Tập đoàn Sunhouse',
        position: 'Brand Executive',
        startDate: '07/2024',
        endDate: 'Hiện tại',
        description:
          'Phối hợp tổ chức chuỗi sự kiện ra mắt bộ sưu tập gia dụng thu hút hơn 2,000 khách tham quan.',
      },
    ],
  },
  ...
  // --- 4. TÀI CHÍNH & KẾ TOÁN (2 Ứng viên) ---
  {
    ...
    careerObjective:
      '4.5 năm kinh nghiệm lập báo cáo tài chính, quyết toán thuế và kiểm soát chi phí doanh nghiệp chính xác tuyệt đối.',
    education: [
      {
        schoolName: 'Học viện Tài chính',
    ...
    workExperience: [
      {
        companyName: 'Công ty Cổ phần Vận tải Á Châu',
        position: 'Kế toán Tổng hợp',
        startDate: '07/2020',
        endDate: 'Hiện tại',
        description:
          'Chịu trách nhiệm toàn bộ sổ sách kế toán, lập báo cáo tài chính năm và làm việc trực tiếp với đoàn thanh tra thuế.',
      },
    ],
  },
  {
    ...
    skills: [
      'Tài chính',
      'Phân tích tài chính',
      'Lập mô hình tài chính (Financial Modeling)',
      'Excel nâng cao',
      'Định giá doanh nghiệp',
      'Quản trị dòng tiền',
    ],
    careerObjective:
      'Chuyên viên phân tích tài chính với 3 năm kinh nghiệm xây dựng mô hình dự báo doanh thu và đánh giá hiệu quả đầu tư dự án.',
    education: [
      {
        schoolName: 'Đại học RMIT Việt Nam',
        major: 'Kinh tế & Tài chính',
        startDate: '09/2018',
        endDate: '06/2022',
      },
    ],
    workExperience: [
      {
        companyName: 'PwC Vietnam',
        position: 'Financial Advisory Associate',
        startDate: '07/2022',
        endDate: 'Hiện tại',
        description:
          'Thực hiện thẩm định tài chính (Due Diligence) cho 10+ thương vụ M&A trong khu vực.',
      },
    ],
  },
  ...
  // --- 5. THIẾT KẾ & SÁNG TẠO (2 Ứng viên) ---
  {
    ...
    careerObjective:
      '4 năm kinh nghiệm thiết kế giao diện sản phẩm số, am hiểu sâu sắc Design System và tối ưu hóa luồng trải nghiệm người dùng.',
    education: [
      {
        schoolName: 'Đại học Kiến trúc TP.HCM',
        major: 'Thiết kế Đồ họa (Graphic Design)',
        startDate: '09/2017',
        endDate: '06/2021',
      },
    ],
    workExperience: [
      {
        ...
        endDate: 'Hiện tại',
        description:
          'Trực tiếp phụ trách thiết kế tính năng Ví Trả Sau và chuyển tiền P2P phục vụ hơn 10 triệu người dùng.',
      },
    ],
  },
  {
    ...
    careerObjective:
      '3 năm kinh nghiệm sản xuất visual quảng cáo sáng tạo, video animation và bộ nhận diện thương hiệu ấn tượng.',
    education: [
      {
        schoolName: 'Đại học Mỹ thuật Công nghiệp Hà Nội',
        major: 'Thiết kế Mỹ thuật Ứng dụng',
        startDate: '09/2019',
        endDate: '06/2023',
      },
    ],
    workExperience: [
      {
        ...
        endDate: 'Hiện tại',
        description:
          'Sáng tạo bộ banner và video motion 3D cho các chiến dịch ra mắt sản phẩm mới của Unilever và Samsung.',
      },
    ],
  },
  ...
  // --- 6. NHÂN SỰ & TUYỂN DỤNG (2 Ứng viên) ---
  {
    ...
    careerObjective:
      'Chuyên gia săn đầu người (Headhunter) ngành IT với mạng lưới hơn 5,000 kỹ sư phần mềm cao cấp tại Việt Nam và Đông Nam Á.',
    education: [
      {
        schoolName: 'Đại học Lao động - Xã hội',
    ...
    workExperience: [
      {
        companyName: 'Navigos Group (VietnamWorks)',
        position: 'Senior IT Recruitment Consultant',
        startDate: '07/2022',
        endDate: 'Hiện tại',
        description:
          'Tuyển dụng thành công 45+ vị trí Tech Lead, Solution Architect cho các tập đoàn quốc tế.',
      },
    ],
  },
  {
    ...
    careerObjective:
      '4 năm kinh nghiệm quản lý chính sách tiền lương, phúc lợi C&B và xử lý quan hệ lao động cho công ty quy mô 500+ nhân sự.',
    education: [
      {
        schoolName: 'Đại học Luật TP.HCM',
        major: 'Luật Thương mại & Lao động',
        startDate: '09/2016',
        endDate: '06/2020',
      },
    ],
    workExperience: [
      {
        ...
        position: 'Chuyên viên Quản trị Tiền lương C&B',
        startDate: '07/2020',
        endDate: 'Hiện tại',
        description:
          'Tính toán lương, thưởng và bảo hiểm hàng tháng chuẩn xác, xây dựng thang bảng lương theo phương pháp Mercer.',
      },
    ],
  },
];
...
async function runSeed() {
  ...
  let compTech = await companyRepo.findOne({
  ...
  let hrTech = await userRepo.findOne({
    where: { email: 'hr@talentpulse.com' },
  });
  const hrTechData = {
  ...
  let compSales = await companyRepo.findOne({
    where: { name: 'GrandLand Real Estate & Commercial Group' },
  });
  if (!compSales) {
  ...
  let hrSales = await userRepo.findOne({
    where: { email: 'hr.grandland@talentpulse.com' },
  });
  const hrSalesData = {
  ...
  console.log(
    `✓ HR Real Estate (Standard): ${hrSales.email} -> ${compSales.name}`,
  );

  // Công ty 3: Digital Marketing & Truyền thông Sáng tạo -> HR STANDARD
  let compMarketing = await companyRepo.findOne({
    where: { name: 'CreativePulse Digital & Media Agency' },
  });
  if (!compMarketing) {
  ...
  let hrMarketing = await userRepo.findOne({
    where: { email: 'hr.creative@talentpulse.com' },
  });
  const hrMarketingData = {
    ...
    premiumPlan: PremiumPlan.FREE,
    company: {
      _id: compMarketing._id,
      name: compMarketing.name,
      isActive: true,
    },
  };
  if (!hrMarketing) {
  ...
  console.log(
    `✓ HR Marketing (Standard): ${hrMarketing.email} -> ${compMarketing.name}`,
  );
  ...
  const salesJobs = [
    {
      ...
      isDeleted: false,
      description:
        'Tìm kiếm trưởng phòng tài năng dẫn dắt đội ngũ 15 nhân viên kinh doanh phân phối dự án nghỉ dưỡng cao cấp.',
    },
    {
      ...
      isDeleted: false,
      description:
        'Tư vấn và chốt hợp đồng căn hộ và biệt thự cho khách hàng có nhu cầu ở và đầu tư.',
    },
    {
      ...
      isDeleted: false,
      description:
        'Liên hệ qua điện thoại giới thiệu các chính sách ưu đãi mở bán dự án BĐS.',
    },
  ];
  ...
  console.log(
    `✓ Đã tạo ${salesJobs.length} tin tuyển dụng ngành Bất động sản & Sales cho ${compSales.name}`,
  );
  ...
  const marketingJobs = [
    {
      ...
      isDeleted: false,
      description:
        'Lên kế hoạch và trực tiếp chạy quảng cáo chuyển đổi đa kênh cho các nhãn hàng đối tác của Agency.',
    },
    {
      ...
      isDeleted: false,
      description:
        'Lên ý tưởng, viết kịch bản và tham gia sản xuất các video viral trên TikTok và Facebook Reels.',
    },
    {
      ...
      isDeleted: false,
      description:
        'Thiết kế giao diện landing page, banner truyền thông và bộ nhận diện thương hiệu.',
    },
  ];
  ...
  console.log(
    `✓ Đã tạo ${marketingJobs.length} tin tuyển dụng ngành Marketing & Design cho ${compMarketing.name}`,
  );
  ...
  for (let i = 0; i < CANDIDATES_DATA.length; i++) {
    ...
    const onlineCv = onlineCvRepo.create({
      ...
      skills: cand.skills.map((s) => ({
        name: s,
        description: 'Thành thạo & có kinh nghiệm thực tế',
      })),
      certificates: [
        { name: `Chứng chỉ nghiệp vụ ${cand.title}`, date: '2023' },
      ],
    ...
    console.log(
      `  [${i + 1}/20] Ứng viên: ${cand.name.padEnd(
        20,
      )} | Vị trí: ${cand.title.padEnd(45)} | ${
        cand.isBoosted
          ? '🚀 TOP'
          : cand.isPremium
          ? '👑 Premium'
  ...
  console.log(
    '🎉 SEED DỮ LIỆU HOÀN TẤT THÀNH CÔNG VỚI 20 ỨNG VIÊN & 3 CÔNG TY!',
  );
  console.log(
    '================================================================',
  );
  ...
  console.log(
    `   • Công ty     : TalentPulse Technology Group (Lĩnh vực: IT / Phần mềm / SaaS)`,
  );
  console.log(
    `   • Hiệu ứng gợi ý: Tự động ưu tiên xếp các ứng viên IT, Fullstack, Backend, DevOps lên đầu!`,
  );
  console.log(
    '----------------------------------------------------------------',
  );
  console.log(
    '2. HR CÔNG TY BẤT ĐỘNG SẢN & KINH DOANH (Gói HR STANDARD - Giới hạn 5 CV/ngày):',
  );
  console.log(`   • Email       : \x1b[36mhr.grandland@talentpulse.com\x1b[0m`);
  console.log(`   • Mật khẩu    : \x1b[33m12345678\x1b[0m`);
  console.log(
    `   • Công ty     : GrandLand Real Estate & Commercial Group (Lĩnh vực: Bất động sản / Sales)`,
  );
  console.log(
    `   • Hiệu ứng gợi ý: Tự động ưu tiên xếp các ứng viên Sales BĐS, Telesales, B2B lên đầu!`,
  );
  console.log(
    '----------------------------------------------------------------',
  );
  console.log(
    '3. HR CÔNG TY DIGITAL MARKETING & CREATIVE AGENCY (Gói HR STANDARD):',
  );
  console.log(`   • Email       : \x1b[36mhr.creative@talentpulse.com\x1b[0m`);
  console.log(`   • Mật khẩu    : \x1b[33m12345678\x1b[0m`);
  console.log(
    `   • Công ty     : CreativePulse Digital & Media Agency (Lĩnh vực: Marketing / Media / Design)`,
  );
  console.log(
    `   • Hiệu ứng gợi ý: Tự động ưu tiên xếp các ứng viên Ads Lead, Content TikTok, SEO, UI/UX lên đầu!`,
  );
  console.log(
    '================================================================\n',
  );
