...
import { CandidateAssistantConsentService } from 'src/candidate-assistant/candidate-assistant-consent.service';
import { getCandidateAssistantConsentPolicy } from 'src/candidate-assistant/candidate-assistant-consent.policy';
