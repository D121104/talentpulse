...
import { JobIndexOutbox } from 'src/job-indexing/entities/job-index-outbox.entity';
import { JobIndexingSubscriber } from 'src/job-indexing/job-indexing.subscriber';
import { JOB_INDEX_VERSION } from 'src/job-indexing/job-indexing.constants';
import { getJobIndexSourceVersion } from 'src/job-indexing/job-indexing.normalization';
