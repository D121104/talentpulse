...
FIXTURE_PATH = (
    Path(__file__).resolve().parents[2] / "contracts" / "job-indexing-normalization-v1.json"
)
...
def test_cross_language_job_normalization_golden_fixture() -> None:
    ...
    assert fixture["fixture_version"] == "job-indexing-normalization-v1"
    assert fixture["normalization_version"] == "job-normalization-v1"
