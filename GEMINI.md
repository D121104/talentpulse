...
3. **Use Skills**: Consult skills in `.agents/skills/` (`graphify`, `backend`, `frontend`, `design-system`, `anti-ai-writing`) for domain-specific implementation rules.
4. **Natural Human Content**: Never generate AI slop, promotional puffery, or banned clichés. Follow `.agents/rules/anti-ai-writing.md`.
