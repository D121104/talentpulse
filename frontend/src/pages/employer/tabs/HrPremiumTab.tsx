      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="rounded-2xl border border-primary/20 bg-primary/5 p-5 dark:border-primary/30 dark:bg-primary/10 space-y-2">
          ...
          <p className="text-xs text-slate-600 dark:text-slate-300">
            Dỡ bỏ hoàn toàn giới hạn 6 tin đang chạy, tạo và quản lý không giới hạn các chiến dịch tuyển dụng.
          </p>
        </div>

        <div className="rounded-2xl border border-amber-500/30 bg-amber-500/5 p-5 dark:border-amber-500/30 dark:bg-amber-500/10 space-y-2">
          <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400 font-bold text-sm">
            <Crown className="h-4.5 w-4.5" />
            <span>Đẩy TOP &amp; Gắn Nhãn HOT</span>
          </div>
          <p className="text-xs text-slate-600 dark:text-slate-300">
            Độc quyền đẩy tin tuyển dụng lên vị trí #1 trang tìm kiếm việc làm, gắn nhãn HOT ngọn lửa nổi bật tăng x3 tương tác.
          </p>
        </div>
