  ...
  const hrMatrix = [
    {
      ...
      features: [
        { name: 'Hạn mức đăng tin tuyển dụng', free: '5 tin/ngày', verified: '5 tin/ngày', premium: 'KHÔNG GIỚI HẠN' },
        { name: 'Thời hạn hiển thị tin', free: '30 ngày', verified: '30 ngày', premium: 'Tùy chỉnh linh hoạt' },
        { name: 'Gắn huy hiệu "Tuyển Gấp" / "Hot Job"', free: false, verified: false, premium: true },
        { name: 'Ưu tiên đẩy tin lên Top đầu tìm kiếm', free: false, verified: '1 lần/tuần', premium: 'Hàng ngày' },
      ],
    },
    {
